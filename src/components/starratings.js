...
// Use .map on the following array to display movie details card that includes a title, year, and a <StarRating /> component for each.
import React from 'react'
import '../componentcss/friendSR.css'
